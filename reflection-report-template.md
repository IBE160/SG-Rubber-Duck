...
- - Til samarbeid ble det benyttet Github [som repository], vi benyttet Teams mest til kommunikasjon med faglærere og noen Teams-møter, i tillegg til at Discord ble en foretrukken platfor for diskusjoner og informasjonsflyt.
- - KI ble naturligvis benyttet i flere deler av prosjeket, fra utarbeidelse av prosjekt proposal til gjennomføring av selve prosjektet, og til sist i deler av denne refleksjonsrapporten. 
...
- - Kunstig intelligens vil trolig endre hvordan IT-sektorens roller fungerer. Oppgaver som før måtte hånteres av en person, som enkle programmeringsoppgaver eller rutinearbeid, vil nok i større grad bli automatisert. Kanskje kan dette også gjelde enkelte vedlikeholdsoppgaver. Men økt bruk av KI vil også krever økt kompetanse innen nettopp KI-integrasjon, systemforståelse, cybersikkerhet og ikke minst etiske vurderinger. Det er også mulig at den typiske rollen som kodeskriver endrer seg til mer å designe, verifisere og optimalisere løsninger i samarbeid med KI, slik vi gjør i dette prosjektet. Så det er ikke bare negative sider ved økt burk av KI, men det kan bety at behovet for tradisjonelle kodeskrivere reduseres.
...
- - Vi delte det vi trengte for å få KI til å utføre den jobben vi ønsket. Men det var selvfølgelig ikke nødvendig å dele informasjon om påloggingsdeltajer eller annen personsensitiv informasjon. I stor grad befant informasjonen seg allerede i proposal-filen og det var heller ikke nødvendig å dele noe form for reell data, applikasjonen kunne testes med testdata. 
...
--KI-genererte koder kan ha både positive og negative implikasjoner. Det kan bidra til med standardiserte koder og ryddige funksjoner, siden KI gjerne bygger på egen språkmodell, såkalt "idometisk kode". Så når man bruker samme språkmodell, vil kodene kunne ligne på hverandre [som om samme person lager to koder]. På den andre siden kan KI lage løsninger som er for generelle, eller lage de unødvendig komplisert og med for mye støy i kodene. Dette kan gjøre det komplisert å gjennomgå koden eller finne feil eller vedlikeholde dem, hvis du må bruke mye tid på overkompliserte koder. Så debuggingen akn bli utfordrende. Også fordi man ikke nødvendigvis kjenner eller forstår hvorfor KI har skrevet koden slik den har. En menneskeskap kode følger gjerne et rasjonelt mønster og har likheter gjennom programmerer-miljøet. Dette kan være noe vi ikke nødvendigvis ser hos KI [ennå].
